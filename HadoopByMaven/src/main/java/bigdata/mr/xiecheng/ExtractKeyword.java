        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            try {
                ...
                for (String keyword : keywords.split(",")) {
                     ...
                     * 去掉青岛和景区这种词汇，对打标签无用处
                     */
                    if (keyword.equals("青岛")
                            || keyword.equals(split[10]) || keyword.equals("景区")) {
                        continue;
                    }
                     ...
                     * 过滤掉副词，时间，人名，动词，方位词
                     */
                    if (tag.containsWordWithLabel("d") || //副词
                            tag.containsWordWithLabel("t") || //时间
                            tag.containsWordWithLabel("nr") || //人名
                            tag.containsWordWithLabel("v") || //动词
                            tag.containsWordWithLabel("f")) { //方位词
                        continue;
                    }
