 ...
 *
 * @Controller jQuery.validator.methods.date("01/01/1900")
 * @result true
 *
 * @Controller jQuery.validator.methods.date("01/13/1990")
 * @result false
 *
 * @Controller jQuery.validator.methods.date("01.01.1900")
 * @result false
 *
 * @Controller <input name="pippo" class="{dateITA:true}" />
...
*
* @Controller jQuery.validator.methods.pattern("AR1004",element,/^AR\d{4}$/)
* @result true
*
* @Controller jQuery.validator.methods.pattern("BR1004",element,/^AR\d{4}$/)
* @result false
*
 ...
 *
 * @Controller <input type="text" size="20" name="VehicleID" class="{required:true,vinUS:true}" />
