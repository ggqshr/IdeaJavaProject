    ...
    <div id="sidebar" class="sidebar                  responsive">
        ...
        <ul class="nav nav-list">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    <li class="">
                        <a data-url="page/typography" href="ajax.jsp#page/AddCombo">
                    ...
                    <li class="">
                        <a data-url="page/elements" href="ajax.jsp#page/DeleteCombo">
                            <i class="menu-icon fa fa-caret-right"></i>
                            删除套餐
                        </a>
                    ...
                    <li class="">
                        <a data-url="page/buttons" href="ajax.jsp#page/QueryAllCombo">
                            <i class="menu-icon fa fa-caret-right"></i>
                            修改套餐
                        </a>
                    ...
                    <%--<li class="">--%>
                    <%--<a data-url="page/treeview" href="ajax.jsp#page/treeview">--%>
                    <%--<i class="menu-icon fa fa-caret-right"></i>--%>
                    <%--Treeview--%>
                    <%--</a>--%>
                    ...
                    <%--<li class="">--%>
                    <%--<a data-url="page/nestable-list" href="ajax.jsp#page/nestable-list">--%>
                    <%--<i class="menu-icon fa fa-caret-right"></i>--%>
                    <%--Nestable Lists--%>
                    <%--</a>--%>
            ...
            <li class="">
                <a href="#" class="dropdown-toggle">
                    ...
                    <span class="menu-text"> 食物管理 </span>
                ...
                <ul class="submenu">
                    <li class="">
                        <a data-url="page/tables" href="ajax.jsp#page/AddFood">
                            <i class="menu-icon fa fa-caret-right"></i>
                            增加食物
                        </a>
                    ...
                    <li class="">
                        <a data-url="page/tables" href="ajax.jsp#page/DeleteFood">
                            <i class="menu-icon fa fa-caret-right"></i>
                            删除食物
                        </a>
                    ...
                    <li class="">
                        <a data-url="page/jqgrid" href="ajax.jsp#page/QueryAllFood">
                            <i class="menu-icon fa fa-caret-right"></i>
                            修改食物
                        </a>
            ...
            <li class="">
                ...
                <ul class="submenu">
                    <li class="">
                        <a data-url="page/form-elements" href="ajax.jsp#page/QueryAllBusiness">
                            <i class="menu-icon fa fa-caret-right"></i>
                            查看所有订单
                        </a>
                    ...
                    <li class="">
                        <a data-url="page/form-wizard" href="ajax.jsp#page/QueryAllBusinessAsCust">
                            <i class="menu-icon fa fa-caret-right"></i>
                            按照客户编号查看订单
                        </a>
                    ...
                    <%--<li class="">--%>
                    <%--<a data-url="page/wysiwyg" href="ajax.jsp#page/wysiwyg">--%>
                    <%--<i class="menu-icon fa fa-caret-right"></i>--%>
                    <%--Wysiwyg &amp; Markdown--%>
                    <%--</a>--%>
                    ...
                    <%--<li class="">--%>
                    <%--<a data-url="page/dropzone" href="ajax.jsp#page/dropzone">--%>
                    <%--<i class="menu-icon fa fa-caret-right"></i>--%>
            ...
            <li class="">
                <a data-url="page/widgets" href="ajax.jsp#page/ChangePwd">
                    <i class="menu-icon fa fa-list-alt"></i>
                    <span class="menu-text"> 修改用户密码 </span>
                </a>
        ...
        if ('enable_ajax_content' in ace) {
            var options = {
                content_url: function (url) {
                    ...
                    if (path.match(/ajax\.jsp/)) /*alert(path.replace(/ajax\.jsp/, url.replace(/^page\//, '') + '.jsp'));*/return path.replace(/ajax\.jsp/, url.replace(/^page\//, '') );
